...
def train(run):
    ...
    for episode in range(1, NUM_TRAIN_EPISODES + 1):
        ...
        for t in range(1, MAX_TRAIN_T + 1):
            ...
            if terminated:
                state_information = (learning_rate, state_0, state, action, reward)
                update_q_table(q_table_a, q_table_b, q_table_c, q_table_d, state_information)
...
def update_q_table(q_table_a, q_table_b, q_table_c, q_table_d, state_information):
    learning_rate, state_0, state, action, reward = state_information
