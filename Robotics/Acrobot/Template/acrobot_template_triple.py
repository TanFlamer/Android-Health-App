...
def train(run, variables):
    ...
    for episode in range(1, NUM_TRAIN_EPISODES + 1):
        ...
        for t in range(1, MAX_TRAIN_T + 1):
            ...
            # Select an action
            action = select_action(state_0, explore_rate, q_table_a + q_table_b + q_table_c, num_actions)
            ...
            if terminated:
                ...
                update_q_table(q_table_a, q_table_b, q_table_c, state_information, parameters, termination)
...
def update_q_table(q_table_a, q_table_b, q_table_c, state_information, parameters, termination):
