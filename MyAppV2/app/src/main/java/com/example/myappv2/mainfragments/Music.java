...
public class Music extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        ViewPager2 viewPager2 = requireView().findViewById(R.id.viewpagerMusic);
        MusicAdapter musicAdapter = new MusicAdapter(getChildFragmentManager(), getLifecycle());

        musicAdapter.addFragment(new Songs());
        musicAdapter.addFragment(new Playlists());
        musicAdapter.addFragment(new MusicStatistics());
        viewPager2.setAdapter(musicAdapter);

        TabLayout tabLayout = requireView().findViewById(R.id.layoutMusic);
