 ...
 * Use the {@link MusicStatisticsFragment#newInstance} factory method to
...
public class MusicStatisticsFragment extends Fragment {
    ...
    public MusicStatisticsFragment() {
    ...
    public static MusicStatisticsFragment newInstance(String param1, String param2) {
        MusicStatisticsFragment fragment = new MusicStatisticsFragment();
